...
import PaymentInternetForm from "../../components/PaymentInternetForm";
import rostelecomLogo from "../../assets/rostelecom.png"
...
export default function InternetPage() {
    ...
    const operators = [
        {
            Icon: <img src={rostelecomLogo} className="w-6 h-9 ml-2 mr-1" />,
            operator: "Ростелеком",
        },
        {
            Icon: <img src="https://avatars.mds.yandex.net/get-socsnippets/12403076/2a0000018c6fed5fa9e2b61a56bdac707d34/square_83" className="w-7 h-7 ml-1 mr-1" />,
            operator: "Дом.ру",
        },
        {
